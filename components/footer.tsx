        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm font-light">
              ...
              <li>
                <Link href="#products" className="hover:text-[#f60700] transition-colors">
                  Products
                </Link>
              </li>
              <li>
                <Link href="/gallery" className="hover:text-[#f60700] transition-colors">
                  Gallery
                </Link>
              </li>
              <li>
                <Link href="/terms" className="hover:text-[#f60700] transition-colors">
                  Terms & Conditions
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3">
              {/* Visa */}
              <div className="bg-white rounded-lg px-4 py-2 flex items-center justify-center h-10 w-16">
              ...
              {/* JCB */}
              <div className="bg-white rounded-lg px-4 py-2 flex items-center justify-center h-10 w-16">
                <svg viewBox="0 0 48 36" className="h-6 w-auto">
